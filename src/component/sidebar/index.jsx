...
function Sidebar({ handleActive }) {
  ...
  const kycmanagement = (flags) => {


    setActivekyc(flags)
  }

  const settingmanagement = (flags) => {


    setActivesetting(flags)
  }

  const bankmanagement = (flags) => {
        ...
        <div className="nav-wrapper mb-[36px] pr-[50px]">
          <div className="item-wrapper mb-5">
            ...
            <ul className="mt-2.5">
              ...
              >
                <a className="cursor-pointer" onClick={() => kycmanagement(!activekyc)}>
                  <div className="flex items-center justify-between">
                    ...
                    <span
                      className={`transition-all ${activekyc ? "-rotate-90" : "rotate-0"
                        }`}
                    >
                      <svg
                        width="6"
                ...
                <ul
                  className={`sub-menu ml-2.5 mt-[22px]  border-l transition-all overflow-hidden border-success-100 pl-5  ${activekyc ? "active" : ""
                    }`}
                >
                  <li>
                    <Link
                  ...
                  <li>
                    <Link
                      to="/kycmanagement?gametype=Rejected"
                      className={`text-md inline-block py-1.5 font-medium text-bgray-600 transition-all hover:text-bgray-800 dark:text-bgray-50 hover:dark:text-success-300 ${location === "/home-3" ? "nav-active" : ""
                        }`}
                    >
                      Rejected
              ...
              <li
                className={`item py-[11px] text-bgray-900 dark:text-white ${location === "/gamehistory?gamename=rummy" ? "nav-active" : ""
                  } `}
              >
                <Link to="/gamehistory?gamename=rummy">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-2.5">
                      <span className="item-ico">
                        <svg
              ...
              >
                <a className="cursor-pointer" onClick={() => bankmanagement(!activebank)}>
                  <div className="flex items-center justify-between">
                    ...
                    <span
                      className={`transition-all ${activebank ? "-rotate-90" : "rotate-0"
                        }`}
                    >
                      <svg
                        width="6"
                ...
                <ul
                  className={`sub-menu ml-2.5 mt-[22px]  border-l transition-all overflow-hidden border-success-100 pl-5  ${activebank ? "active" : ""
                    }`}
                >
                  <li>
                    <Link
                      to="/bankmanagement?status=Pendding"
                      className={`text-md inline-block py-1.5 font-medium text-bgray-600 transition-all hover:text-bgray-800 dark:text-bgray-50 hover:dark:text-success-300 ${location === "/home-2" ? "nav-active" : ""
                        }`}
                    >
                      Pending
                  ...
                  <li>
                    <Link
                      to="/bankmanagement?status=Approved"
                      className={`text-md inline-block py-1.5 font-medium text-bgray-600 transition-all hover:text-bgray-800 dark:text-bgray-50 hover:dark:text-success-300 ${location === "/home-3" ? "nav-active" : ""
                        }`}
                    >
                      Approved
                  ...
                  <li>
                    <Link
                      to="/bankmanagement?gametype=Rejected"
                      className={`text-md inline-block py-1.5 font-medium text-bgray-600 transition-all hover:text-bgray-800 dark:text-bgray-50 hover:dark:text-success-300 ${location === "/home-3" ? "nav-active" : ""
                        }`}
                    >
                      Rejected
              ...
              <li
                className={`item py-[11px] text-bgray-900 dark:text-white ${location === "/transcationPage" ? "nav-active" : ""
                  } `}
              >
                <Link to="/transcationPage">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-2.5">
                      <span className="item-ico">
                        <svg
              ...
              >
                <a className="cursor-pointer" onClick={() => settingmanagement(!activesetting)}>
                  <div className="flex items-center justify-between">
                    ...
                    <span
                      className={`transition-all ${activesetting ? "-rotate-90" : "rotate-0"
                        }`}
                    >
                      <svg
                        width="6"
